    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#09090b] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white dark:bg-[#0f0f10] rounded-2xl shadow-xl border border-slate-100 dark:border-neutral-800 p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-neutral-400 text-sm mt-1">Hesabınıza giriş yapın</p>
        </div>
        ...
        <form onSubmit={handleCredentials} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-neutral-300 mb-1.5">Şifre</label>
            <input
        ...
        <p className="text-center text-sm text-slate-500 dark:text-neutral-400 mt-6">
          Hesabınız yok mu?{' '}
          <a href="/register" className="text-slate-900 dark:text-white font-semibold hover:underline">Kayıt Ol</a>
        </p>
      </div>
    </div>
  );
