...
const dictionary: Record<string, Record<Locale, string>> = {
  ...
  "Ödenecek": { tr: "Ödenecek", en: "Pending" },
  "Gelecek Ödeme": { tr: "Gelecek Ödeme", en: "Upcoming" },
  "bekleyen": { tr: "bekleyen", en: "pending" },
  "Yardım / SSS": { tr: "Yardım / SSS", en: "Help / FAQ" },
  "Maaş yattı": { tr: "Maaş yattı", en: "Salary deposited" },
  "Hesabınıza 130.000 TL transfer edildi.": { tr: "Hesabınıza 130.000 TL transfer edildi.", en: "130,000 TL transferred to your account." },
